...
"v22_int_STAR" : ["AuAu 200 GeV", ['salmon','lightskyblue','red','black'], [[0,85],[0,0.25],[0,85],[-34,34]], ["$v_2$", "Centrality (%)"], 1, 'linear'],
"v32_int_STAR" : ["AuAu 200 GeV", ['salmon','lightskyblue','red','black'], [[0,85],[0,0.03],[0,85],[-34,34]], ["$v_3$", "Centrality (%)"], 1, 'linear'],
